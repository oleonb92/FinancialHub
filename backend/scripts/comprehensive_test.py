...
Uso:
    python backend/scripts/comprehensive_test.py --mode train
    python backend/scripts/comprehensive_test.py --mode verify
    python backend/scripts/comprehensive_test.py --mode test
    python backend/scripts/comprehensive_test.py --mode cleanup
"""
