...
class AutoTrainingSetup:
        ...
        self.cron_jobs = [
            {
                ...
                'command': f'cd {self.project_path} && python scripts/schedule_ai_training.py scheduled >> logs/cron.log 2>&1',
            ...
            },
            {
                ...
                'command': f'cd {self.project_path} && python scripts/schedule_ai_training.py status >> logs/status.log 2>&1',
    ...
    def setup_logs(self):
        ...
        log_files = [
            self.logs_dir / 'ai_training.log',
            self.logs_dir / 'cron.log',
            self.logs_dir / 'status.log'
        ]
...
def main():
    ...
    if setup.run_setup():
        ...
        print("\n🔍 Para verificar:")
        print("  • Estado: python scripts/schedule_ai_training.py status")
        print("  • Logs: tail -f logs/ai_training.log")
